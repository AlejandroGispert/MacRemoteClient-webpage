<script>
	...
	const currentVersion = { version: '2.2', filename: 'MacRCDesktop_v2.2.dmg', label: 'v2.2 (Latest)', current: true, downloadUrl: `${GITHUB_BASE}/2.2/MacRCDesktop.v2.2.Install.dmg` };
	const oldVersions = [
